...
<header id="home" style="">
    ...
    <nav class="navbar navbar-expand-md navbar-light default">
      <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/images/logo-dark.svg"
            alt="logo"> </a><button class="navbar-toggler rounded" type="button" data-bs-toggle="collapse"
      ...
      <div class="row justify-content-center">
        <div class="col-md-10 text-center">
          ...
          <div class="row justify-content-center wow fadeInUp" data-wow-delay="0.3s">
            <div class="col-md-8">
              <p class="text-muted f-16 mb-0">Nikmati Beragam Konten Eksklusif dari Berbagai Topik Menarik. Dari Tren Terbaru, Inspirasi Gaya Hidup, Teknologi Terkini, Hingga Wisata Menakjubkan. Bergabunglah dengan Ribuan Pembaca Setia Kami dan Temukan Wawasan Baru di Setiap Edisi.</p>
            </div>
          </div>
