            ...
            <div class="card-body">
            	<div class="d-flex justify-content-between">
	              <h6 class="mb-2">Kategori</h6>
            		<a href="kategori-add.php" class="btn btn-sm btn-primary">Tambah Kategori</a>
            	</div>
	                	...
	                	<?php if ($data): ?>
	                		...
	                		<?php foreach ($data as $val): ?>
	                			...
	                			<tr>
	                				...
	                				<td><?= $val["nama"] ?></td>
	                				<td>
	                					<a href="kategori-edit.php?id=<?= $val["id_kategori"] ?>" class="p-1 mb-0 btn btn-sm btn-secondary">Edit</a>
	                					<a href="hapus.php?id=<?= $val["id_kategori"] ?>&data=kategori" class="p-1 mb-0 btn btn-sm btn-danger">Hapus</a>
	                				</td>
	                			</tr>
