            ...
            <div class="card-body">
            	<div class="d-flex justify-content-between">
	              <h6 class="mb-2">Tag</h6>
            		<a href="tag-add.php" class="btn btn-sm btn-primary">Tambah Tag</a>
            	</div>
	                	...
	                	<?php if ($data): ?>
	                		...
	                		<?php foreach ($data as $val): ?>
	                			...
	                			<tr>
	                				...
	                				<td><?= $val["nama"] ?></td>
	                				<td>
	                					<a href="tag-edit.php?id=<?= $val["id_tag"] ?>" class="p-1 mb-0 btn btn-sm btn-secondary">Edit</a>
	                					<a href="hapus.php?id=<?= $val["id_tag"] ?>&data=tag" class="p-1 mb-0 btn btn-sm btn-danger">Hapus</a>
	                				</td>
	                			</tr>
