<?php
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    $paket_pembelian = '';
    if ($row['harga_digital'] > 0 && $row['harga_cetak'] > 0 && $row['harga_keduanya'] > 0) {
      $paket_pembelian = 'Digital & Cetak';
    } elseif ($row['harga_digital'] > 0 && $row['harga_cetak'] > 0) {
      $paket_pembelian = 'Digital & Cetak';
    ...
    $status_pembayaran = $row['status_pembayaran'] == 1 ? 'Sudah Dibayar' : 'Menunggu Konfirmasi Pembayaran Dari Admin';
     ...
     $rekening_text = '';
     if ($row['metode_pembayaran'] == 'BRI') {
       $rekening_text = '
         <h5>Pastikan anda melakukan pembayaran ke :</h5>
         <h3 class="rekening-bri">BRI 31243 1233 123</h3>
         <h3 class="rekening-bri">A.n Admin</h3>
         <h3 class="rekening-bri">Jumlah Yang Harus Dibayarkan : ' . $harga . '</h3>
       ';
     } elseif ($row['metode_pembayaran'] == 'BCA') {
       $rekening_text = '
         <h5>Pastikan anda melakukan pembayaran ke :</h5>
         <p class="rekening-bca">BCA 31243 1233 123</p>
         <p class="rekening-bca">A.n Admin</p>
         <p class="rekening-bca">Jumlah Yang Harus Dibayarkan : ' . $harga . '</p>
       ';
     } elseif ($row['metode_pembayaran'] == 'BNI') {
       $rekening_text = '
         <h5>Pastikan anda melakukan pembayaran ke :</h5>
         <p class="rekening-bni">BNI 31243 1233 123</p>
         <p class="rekening-bni">A.n Admin</p>
         <p class="rekening-bni">Jumlah Yang Harus Dibayarkan : ' . $harga . '</p>
       ';
     } elseif ($row['metode_pembayaran'] == 'BSI') {
       $rekening_text = '
         <h5>Pastikan anda melakukan pembayaran ke :</h5>
         <p class="rekening-bsi">BSI 31243 1233 123</p>
         <p class="rekening-bsi">A.n Admin</p>
         <p class="rekening-bsi">Jumlah Yang Harus Dibayarkan : ' . $harga . '</p>
       ';
     } else {
      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                <h5>ID Transaksi: <?= strtoupper($row['no_transaksi']) ?></h5>
              </div>
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-4 text-end">
                    ...
                    <p class="fs-5"><?= strtoupper($row['no_transaksi']) ?></p>
                </div>
            </div>
